...
const ITEMS: { label: string; description: string; href: string; icon: typeof Plus; permission: Permission }[] = [
  { label: 'Payroll run', description: 'Prepare a month’s pay', href: '/portal/financial/payroll/new', icon: ClipboardList, permission: 'payroll.prepare' },
  { label: 'Employee', description: 'Add one person to payroll', href: '/portal/financial/employees/new', icon: UserPlus, permission: 'employees.edit' },
  { label: 'Import employees', description: 'Upload a CSV of your staff', href: '/portal/financial/employees/import', icon: Upload, permission: 'employees.edit' },
  { label: 'Tax configuration', description: 'Draft PAYE bands and SSNIT rates', href: '/portal/financial/tax?new=1', icon: Percent, permission: 'tax.draft' },
  { label: 'User', description: 'Invite someone and choose their role', href: '/portal/financial/users/invite', icon: KeyRound, permission: 'users.manage' },
]
